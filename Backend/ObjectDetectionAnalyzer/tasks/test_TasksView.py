...
class TestTasksView(APITestCase):
    ...
    @patch('ObjectDetectionAnalyzer.tasks.TasksView.TasksView._execute_task')
    ...
    @patch('ObjectDetectionAnalyzer.tasks.TasksView.TasksView._write_model_predictions')
    ...
    @patch('ObjectDetectionAnalyzer.tasks.TasksView.TasksView._get_predictions')
    ...
    def test_execute_task(self, get_image_files_from_dir, get_detections, read_label_map, replace_class_names,
        ...
        self.tasks_view._execute_task(dataset, "desc", "file_name", model, "task_name", self.user)
    ...
    def test_write_model_predictions(self, get_combined_dir, get_dataset_dir, get_predictions_dir, create_dir,
        ...
        self.tasks_view._write_model_predictions(dataset, "file_name", {"predictions"}, self.user)
    ...
    def test_get_detections_tf1(self, get_detections_for_task_images):
        ...
        result = self.tasks_view._get_predictions(None, model, None)
