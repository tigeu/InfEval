...
class TestUploadPyTorchModelView(APITestCase):
    """
    Test UploadPyTorchModelView
    """
    ...
    def test_save_data_with_prediction(self, save_data, update):
        ...
        Models.objects.create(name="model_name", path="target", type='pytorch', userId=user)
    ...
    def test_save_data_without_prediction(self, save_data, create):
        ...
        create.assert_called_with(name="new_model_name", path=Path("target"), type='pytorch', userId=user)
